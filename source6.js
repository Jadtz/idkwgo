...
const GUYA_ALL_SERIES_API = `https://raw.githubusercontent.com/Jadtz/idkwgo/main/sfm%20guya.json`;
const GUYA_POP_SERIES_API = `https://raw.githubusercontent.com/Jadtz/idkwgo/main/sfm%20guya.json`;
const GUYA_DRAMA_SERIES_API = `https://raw.githubusercontent.com/Jadtz/idkwgo/main/categories/Drama.json`;
...
class Guya extends paperback_extensions_common_1.Source {
    ...
    getHomePageSections(sectionCallback) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var homeSection = createHomeSection({ id: "all_guya", title: "All Titles" });
            var popSection = createHomeSection({ id: "pop_guya", title: "Popular" });
            var dramaSection = createHomeSection({ id: "drama_guya", title: "Drama" });
            sectionCallback(homeSection);
            sectionCallback(popSection);
            sectionCallback(dramaSection);
            ...
            const request2 = createRequestObject({
                url: GUYA_DRAMA_SERIES_API,
                method: "GET"
            });
            const data2 = yield this.requestManager.schedule(request2, 1);
            let result2 = typeof data2.data === "string" ? JSON.parse(data2.data) : data2.data;
            let mangas2 = [];
            ...
            popSection.items = mangas;
            dramaSection.items = mangas2;
            sectionCallback(homeSection);
            sectionCallback(popSection);
            sectionCallback(dramaSection);
        });
